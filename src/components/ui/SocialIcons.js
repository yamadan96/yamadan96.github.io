...
const NoteIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M22.904 6.155s-1.633-.636-4.408-.207c-1.182.183-3.823.822-5.04 1.553-.406.244-.394.744-.394.744l.009 10.853s-.063.718.581.39c.862-.439 2.882-1.3 4.24-1.544 2.57-.46 4.96-.074 4.96-.074s.353.07.353-.349V6.459c0-.2-.07-.287-.3-.304zm-7.98 10.07V7.13s-.027-.68.552-.98c0 0 1.762-1.042 4.625-1.289 0 0-4.397 1.467-4.588 3.09-.063.544-.001 8.274-.001 8.274h-.587zM8.27 3.5L2.428 5.298s-.478.14-.478.636v12.368s0 .39.335.347c0 0 1.952-.308 4.167.061 2.688.448 3.96 1.99 3.96 1.99s.204-.283.204-.77V4.147s.072-.563-.345-.648zm-.794 13.6s-1.232-.676-3.354-.588c-1.294.054-2.453.36-2.453.36V5.8l5.807-1.555v12.854z" />
  </svg>
);
...
const WantedlyIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor">
    <path d="M18.453 14.555c-.171-.111-.37-.084-.484.057-.855 1.056-2.082 1.711-3.473 1.711-1.855 0-3.453-1.141-4.141-2.784h9.057c.199 0 .37-.142.398-.341.029-.199.057-.398.057-.597 0-3.937-3.196-7.133-7.133-7.133S5.601 8.663 5.601 12.601c0 3.937 3.196 7.133 7.133 7.133 2.283 0 4.365-1.084 5.677-2.784.142-.171.142-.398-.057-.512l-.901-.883zM12.734 8.07c1.855 0 3.453 1.141 4.141 2.784H8.593c.688-1.643 2.286-2.784 4.141-2.784z" />
  </svg>
);

const socialIcons = { github: GitHubIcon, qiita: QiitaIcon, x: XIcon, linkedin: LinkedInIcon, note: NoteIcon, zenn: ZennIcon, wantedly: WantedlyIcon };
